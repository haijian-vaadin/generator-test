...
import stylesCss from 'themes/generator-test/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_generator-test_componentCss']) {
    
    document['_vaadintheme_generator-test_componentCss'] = true;
  }
